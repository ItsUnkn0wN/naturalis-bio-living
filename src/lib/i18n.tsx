...
export const t = {
  ...
  products: {
    ...
    pageSub: {
      sr: "Pogledajte proizvode, cene i kategorije. Zalihe se menjaju – pozovite ili svratite za potvrdu.",
      hu: "Tekintse meg a termékeket, árakat és kategóriákat. A készlet változik – érdeklődjön üzletünkben.",
      en: "Browse the products, prices and categories. Stock changes, so call or visit us to confirm availability.",
    },
