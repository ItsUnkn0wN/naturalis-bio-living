...
export const t = {
  ...
  quiz: {
    ...
    title: {
      sr: "Ne znate odakle da krenete?",
      hu: "Nem tudja, hol kezdje?",
  ...
  products: {
    ...
    featuredTitle: {
      sr: "Izdvojeni proizvodi sa naših polica",
      hu: "Polcainkról kiemelt termékeink",
      en: "Featured products from our shelves",
    },
    pageTitle: { sr: "Ponuda", hu: "Kínálat", en: "Our range" },
    pageSub: {
      sr: "Pogledajte proizvode, cene i kategorije. Posebno izdvajamo Kimérős termékek – zalihe se menjaju, pa pozovite ili svratite za potvrdu.",
      hu: "Tekintse meg a termékeket, árakat és kategóriákat. Külön szekcióban találja a Kimérős termékek kínálatot – a készlet változik, ezért érdeklődjön üzletünkben.",
    ...
    highestPrice: { sr: "Najviša cena", hu: "Legmagasabb ár", en: "Highest price" },
    sortDefault: { sr: "Po izboru", hu: "Alapértelmezett", en: "Featured order" },
    viewAll: { sr: "Cela ponuda", hu: "Teljes kínálat", en: "Full range" },
    quickView: { sr: "Detalji", hu: "Részletek", en: "Details" },
    price: { sr: "Cena", hu: "Ár", en: "Price" },
    imagePending: {
      sr: "Slika proizvoda biće dodata",
      hu: "A termékkép hamarosan érkezik",
    ...
    empty: {
      sr: "Nema proizvoda u ovoj kategoriji.",
      hu: "Nincs termék ebben a kategóriában.",
  ...
  story: {
    ...
    title: {
      sr: "Mala radnja, velika briga.",
      hu: "Kis bolt, nagy odafigyelés.",
    ...
    quality: {
      ...
      en: "hand-picked, nothing random",
    },
    owner: { sr: "Vlasnik", hu: "Tulajdonos", en: "Owner" },
    values: { sr: "U šta verujemo", hu: "Amiben hiszünk", en: "What we stand for" },
    v1t: {
      sr: "Sastav pre marketinga",
      hu: "Összetétel a marketing előtt",
      en: "Ingredients before marketing",
    },
    v1: {
      sr: "Prvo čitamo deklaraciju, pa tek onda etiketu.",
      hu: "Előbb az összetevőket olvassuk, csak aztán a címkét.",
      en: "We read the label's back before its front.",
    },
    v2t: {
      sr: "Domaće kad god može",
      hu: "Hazai, amikor csak lehet",
      en: "Local whenever possible",
    },
    v2: {
      sr: "Med, ulja, začini i džemovi od ljudi koje znamo.",
      hu: "Méz, olajok, fűszerek és lekvárok olyanoktól, akiket ismerünk.",
      en: "Honey, oils, spices and jams from people we know.",
    },
    v3t: { sr: "Savet, ne prodaja", hu: "Tanács, nem rábeszélés", en: "Advice, not a pitch" },
    v3: {
      sr: "Ako vam nešto ne treba, reći ćemo vam.",
      hu: "Ha valamire nincs szüksége, megmondjuk.",
      en: "If you don't need it, we'll tell you.",
    },
  ...
  contact: {
    ...
    title: {
      sr: "Zanatlijska 10, Mali Iđoš",
      hu: "Zanatlijska 10, Kishegyes",
  ...
  seo: {
    home: {
      title: {
        sr: "Naturalis Mali Iđoš – bio i prirodni proizvodi",
        hu: "Naturalis Kishegyes – bio és természetes termékek",
    ...
    products: {
      title: {
        sr: "Ponuda – Naturalis Mali Iđoš",
        hu: "Kínálat – Naturalis Kishegyes",
        en: "Our range – Naturalis Mali Iđoš",
      },
      desc: {
    ...
    story: {
      title: {
        sr: "Naša priča – Naturalis Mali Iđoš",
        hu: "Történetünk – Naturalis Kishegyes",
    ...
    contact: {
      title: {
        sr: "Posetite nas – Naturalis, Zanatlijska 10, Mali Iđoš",
        hu: "Látogasson el – Naturalis, Zanatlijska 10, Kishegyes",
        en: "Visit us – Naturalis, Zanatlijska 10, Mali Iđoš",
      },
      desc: {
