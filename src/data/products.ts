...
export const tagLabels: Record<Tag, Localized> = {
  ...
  "stress-relief": { sr: "Za stres", hu: "Stresszoldás", en: "Stress relief" },
  "immune-system": { sr: "Imunitet", hu: "Immunrendszer", en: "Immune system" },
  "joint-support": { sr: "Za zglobove", hu: "Ízületi problémákra", en: "Joint support" },
};
