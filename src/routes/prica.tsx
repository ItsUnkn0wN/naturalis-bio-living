      ...
      <div className="grid items-start gap-10 lg:grid-cols-[1fr_0.9fr]">
        ...
        <Reveal delay={0.1}>
          <div className="grid grid-cols-2 gap-3">
            ...
            <img
              src={shopShelves.url}
              alt="Police sa uljima i čajevima"
              width={784}
              height={588}
              loading="lazy"
              className="aspect-[4/3] w-full rounded-3xl object-cover shadow-soft"
      ...
      <section className="mt-20">
        ...
        <Reveal className="mt-10 text-center">
          <Link
            to="/kontakt"
            search={(p) => p}
            className="inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3.5 font-semibold text-primary-foreground shadow-lift"
          >
